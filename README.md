...
![safe-eye](./static/banner-safe-eye.webp)
...
- [Safe Eye 프로젝트 ERD](#safe-eye-프로젝트-erd)
  - [1. 모델 설명](#1-모델-설명)
    ...
    - [1.6 chat 앱](#16-chat-앱)
      - [1.6.1 ChatRoom 모델](#161-chatroom-모델)
      - [1.6.2 Message 모델](#162-message-모델)
      - [1.6.3 ChatConsumer 모델](#163-chatconsumer-모델)
  - [2. ERD](#2-erd)
  - [Notice 앱](#notice-앱)
  - [푸터](#푸터)
...
- 정진영(팀원): accounts 앱 및 chat 앱 개발을 담당하고 있으며, 모델링을 분담하고 있습니다. 더불어 사용자 인증과 관련된 기능들(정보 관리, 권한 부여 등), 채팅방 생성 기능, 실시간 채팅 기능들을 구현했습니다.

- 박경민(팀원): 적절한 경고 메시지를 커스텀하고, 와이어프레임을 제작했습니다.
